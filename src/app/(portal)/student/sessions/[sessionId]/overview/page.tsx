// src/app/(portal)/student/sessions/[sessionId]/overview/page.tsx
...
export default function StudentSessionOverviewPage() {
  ...
  const sessionId = params.sessionId; // <-- Access sessionId from params
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <div className="flex space-x-4">
                  <button 
                    onClick={() => router.push(`/student/chat/${sessionId}`)} // <-- Use router.push
                  ...
                  <button 
                    onClick={() => router.push(`/student/sessions/${sessionId}/quiz`)} // <-- Use router.push
